...
// 6
const cut = challenge.substr(challenge.indexOf(' ') + 1);
console.log(rmvword);
...
// 9
const newArray = challenge.split(' ');

// 10
const newArray2 = challenge.split(' ');
...
// 13
const char15 = challenge.charAt(15);

// 14
const Codechar = challenge.charCodeAt(challenge.indexOf('J'));
...
// 20
const Stringtrim = ' 30 Days Of JavaScript '.trim();

// 21
const startResult = challenge.startsWith('30 Days Of JavaScript');

// 22
const endsResult = challenge.endsWith('30 Days Of JavaScript');
